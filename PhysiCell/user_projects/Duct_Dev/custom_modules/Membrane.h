...
// Structural Forces
void distribute_force_linear(std::vector<std::pair<double,double>>& node_forces, double Fx_BM, double Fy_BM, int best_k, double best_t);
void BM_Smoothing(std::vector<std::pair<double,double>>& node_forces, double Fx_BM, double Fy_BM, int best_k, double best_px, double best_py, double best_t, const std::vector<double>& edge_length);
...
void membrane_bending_stiffness(std::vector<std::pair<double,double>>& node_forces, const std::vector<double>& edge_length);
